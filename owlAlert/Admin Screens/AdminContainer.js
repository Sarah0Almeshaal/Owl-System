      ...
      <Tab.Navigator
        ...
        screenOptions={({ route }) => ({
          ...
          tabBarLabel: ({ focused, color, size }) => {
            return <Text style={{ color: focused ? 'white' : color }}>{route.name}</Text>
          },
          tabBarStyle: { backgroundColor: '#284389', paddingBottom: 10, width: 350, borderRadius: 15, left: 14, bottom: 10},
        })}
      >
        ...
        <Tab.Screen name={"alertDetails"} component={AlertDetails} options={{
        tabBarButton: () => null,
        tabBarVisible:false}}/>
