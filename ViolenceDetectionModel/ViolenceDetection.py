...
#     "C:/Users/sleep/OneDrive/Desktop/Senior [2]/Final Project/Owl-System/ViolenceDetectionModel/Model/modelnew.h5"
# )
...
path = "C:/Users/Sara_/Desktop/FCIT/LVL10/CPIT-499/Datasets/archive (2)/Real Life Violence Dataset/Violence/V_3.mp4"
##################### < Violence Detect > ######################
...
for item in c.query(wql):
    if item.Dependent.PNPClass == "Camera":
        camName = item.Dependent.Name
        if (camName != "Integrated Camera"):
            camThreads.append(camThread(camName, index))
